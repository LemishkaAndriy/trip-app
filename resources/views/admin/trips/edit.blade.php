        ...
        <div class="card-body">
            <form method="POST" action="{{ route("admin.trips.update", [$trip->id]) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('trip') ? 'is-invalid' : '' }}" type="number" name="trip" id="trip" value="{{ old('trip', $trip->trip) }}" step="1" required>
                    @if($errors->has('trip'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('driver') ? 'is-invalid' : '' }}" type="number" name="driver" id="driver" value="{{ old('driver', $trip->driver) }}" step="1" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control datetime {{ $errors->has('pick_up') ? 'is-invalid' : '' }}" type="text" name="pick_up" id="pick_up" value="{{ old('pick_up', $trip->pick_up) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control datetime {{ $errors->has('drop_off') ? 'is-invalid' : '' }}" type="text" name="drop_off" id="drop_off" value="{{ old('drop_off', $trip->drop_off) }}" required>
